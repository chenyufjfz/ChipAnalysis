...
public slots:
	...
	*/
    ...
    void extract_single_wire(string prj, int layer, int wmin, int wmax, int ihigh, int opt, int gray_th, int channel, int scale, int x, int y, float cr, float cg, int shape_mask);
